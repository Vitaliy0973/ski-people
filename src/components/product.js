  ...
  const child = `
    ...
    <div class="product__wrap">
      ...
      <div class="product__slider-container">
        <div class="swiper product__main-slider main-slider">
          <div class="swiper-wrapper main-slider__wrap">

            <div class="swiper-slide main-slider__item">
              <img class="main-slider__img" src="/img/snowboard.jpg" alt="">
            </div>
          ...
          <div class="swiper-button-next main-slider__btn main-slider__btn_next">
          ...
          <div class="swiper-button-prev main-slider__btn main-slider__btn_prev">
            <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="swiper product__slider-thumbnails slider-thumbnails">
          <div class="swiper-wrapper slider-thumbnails__wrap">

            <div class="swiper-slide slider-thumbnails__item">
              <img class="slider-thumbnails__img" src="/img/snowboard-mini.jpg" alt="">
            </div>
      ...
      <div class="product__info">
        ...
        <div class="product__btn-wrap">
          <button class="product__button" type="button">В корзину</button>
